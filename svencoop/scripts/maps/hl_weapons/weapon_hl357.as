...
class weapon_hl357 : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_SoundSystem.PrecacheSound( "hlclassic/weapons/357_shot3.wav" );
	}
	...
	void PrimaryAttack()
	{
		...
		case 0:
			...
			break;
		case 1:
			g_SoundSystem.EmitSoundDyn( m_pPlayer.edict(), CHAN_WEAPON, "hlclassic/weapons/357_shot3.wav", 1.0, ATTN_NORM, 0, 95 + Math.RandomLong( 0, 10 ) );
			break;
		}
