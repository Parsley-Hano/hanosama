...
void PluginInit()
{
	...
	@g_finishPercent = CCVar("percent", 66, "Percentage of players needed for level change", ConCommandFlag::AdminOnly);
	@g_finishDelay = CCVar("delay", 3.0f, "Seconds to wait before changing level", ConCommandFlag::AdminOnly);
